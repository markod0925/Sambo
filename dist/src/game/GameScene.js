...
export class GameScene extends Phaser.Scene {
    metronome = new Metronome(ANALYSIS.bpm, 4);
    mover = new BeatSnapMover(this.metronome, 64);
    player;
    moon;
    infoText;
    livesText;
